            ...
            <div class="BARCON">
                ...
                <div id="Editor-sidebar" display="block">
                    <div className="Editor-explorer">
                        ...
                        <button class="menu-B" onClick={this.saveToDatabase.bind(this)} >Save to database</button>
                        <button class="menu-C" onClick={this.getFromDatabase.bind(this)} >Get from database</button>
                ...
                <div className="Editor-Top-Menu">
                    <div className="Request-Field">
                        ...
                        <text class="text-glow">
                             Host or User {/*Change to  this.state.host_status ? 'Host' : 'User'*/}
